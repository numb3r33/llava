  ...
  'syms': { 'llava.conversation': { 'llava.conversation.Conversation': ('conversation.html#conversation', 'llava/conversation.py'),
            ...
            'llava.training.core': { 'llava.training.core.LLaVALoss': ('training_core.html#llavaloss', 'llava/training/core.py'),
                                     ...
                                     'llava.training.core.LLaVALoss.forward': ( 'training_core.html#llavaloss.forward',
                                                                                'llava/training/core.py'),
                                     'llava.training.core.LLaVAMixedPrecision': ( 'training_core.html#llavamixedprecision',
                                                                                  'llava/training/core.py'),
                                     'llava.training.core.LLaVAMixedPrecision.after_pred': ( 'training_core.html#llavamixedprecision.after_pred',
                                                                                             'llava/training/core.py'),
                                     'llava.training.core.SafeGradientAccumulation': ( 'training_core.html#safegradientaccumulation',
                                                                                       'llava/training/core.py'),
                                     'llava.training.core.SafeGradientAccumulation.after_loss': ( 'training_core.html#safegradientaccumulation.after_loss',
                                                                                                  'llava/training/core.py'),
                                     'llava.training.core.extract_loss_from_output': ( 'training_core.html#extract_loss_from_output',
                                                                                       'llava/training/core.py')},
